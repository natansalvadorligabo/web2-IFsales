...
<html lang="pt-br" data-theme="lofi">
    <jsp:include page="/components/head.jsp">
        <jsp:param name="title" value="Tabela de Vendas - IFSales" />
    </jsp:include>
<body>
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content flex flex-col items-center">
        <jsp:include page="/components/navbar.jsp">
            <jsp:param name="title" value="Tabela de Vendas" />
        </jsp:include>

        <div class="container mx-auto p-4">
            <div class="flex items-center justify-between mb-6 mt-8">
                <h1 class="text-2xl font-bold">Vendas</h1>
                <a class="btn btn-success btn-circle" href="${pageContext.request.contextPath}/redirect?action=loadFunnelForm">
            ...
            <div class="stats stats-vertical shadow-md w-full">
                <div class="overflow-x-auto">
                    <table class="table table-zebra">
                        ...
                        <tbody>
                        <c:forEach var="funnel" items="${funnels}">
                            <tr class="hover">
                                <td>${funnel.id}</td>
                                <td>${funnel.customer.firstName} ${funnel.customer.lastName}</td>
                                ...
                                <td class="p-1 flex">
                                    ...
                                    <button onclick="document.getElementById('delete-${funnel.id}').showModal()" class="btn btn-outline btn-error w-1/2">
                                    ...
                                    <dialog id="edit-${funnel.id}" class="modal">
                                        <div class="modal-box">
                                            <h3 class="text-lg font-bold">Editar</h3>
                                            <p class="py-4">Tem certeza que deseja editar a venda de ${funnel.salesperson.name} | ${funnel.productQuantity} ${funnel.product.model}?</p>
                                            ...
                                            <div class="modal-body flex justify-between">
                                                ...
                                                <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=updateFunnel&id=${funnel.id}">
                                                    Editar
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <dialog id="delete-${funnel.id}" class="modal">
                                        <div class="modal-box">
                                            <h3 class="text-lg font-bold">Deletar</h3>
                                            <p class="py-4">Tem certeza que deseja deletar a venda de ${funnel.salesperson.name} | ${funnel.productQuantity} ${funnel.product.model}?</p>
                                            ...
                                            <div class="modal-body flex justify-between">
                                                ...
                                                <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=deleteFunnel&id=${funnel.id}">
                                                    Deletar
                                                </a>
                                            </div>
                                        </div>
