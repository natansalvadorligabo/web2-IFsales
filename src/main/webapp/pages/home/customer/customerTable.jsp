...
<div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content flex flex-col items-center">
        <jsp:include page="/components/navbar.jsp">
            <jsp:param name="title" value="Tabela de Clientes" />
        </jsp:include>

        <div class="container mx-auto p-4">
            <div class="flex items-center justify-between mb-6 mt-8">
                <h1 class="text-2xl font-bold">Clientes</h1>
                <a class="btn btn-success btn-circle" href="${pageContext.request.contextPath}/redirect?action=loadCustomerForm">
                        ...
                        <c:forEach var="customer" items="${customers}">
                            <tr class="hover">
                                ...
                                <td class="p-1 flex">
                                    ...
                                    <button onclick="document.getElementById('delete-${customer.id}').showModal()" class="btn btn-outline btn-error w-1/2">
                                    ...
                                    <dialog id="edit-${customer.id}" class="modal">
                                        <div class="modal-box">
                                            <h3 class="text-lg font-bold">Editar</h3>
                                            <p class="py-4">Tem certeza que deseja editar "${customer.firstName}"?</p>
                                            ...
                                            <div class="modal-body flex justify-between">
                                                ...
                                                <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=updateCustomer&id=${customer.id}">
                                                    Editar
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <dialog id="delete-${customer.id}" class="modal">
                                        <div class="modal-box">
                                            <h3 class="text-lg font-bold">Deletar</h3>
                                            <p class="py-4">Tem certeza que deseja deletar "${customer.firstName}"?</p>
                                            ...
                                            <div class="modal-body flex justify-between">
                                                ...
                                                <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=deleteCustomer&id=${customer.id}">
                                                    Deletar
                                                </a>
                                            </div>
                                        </div>
