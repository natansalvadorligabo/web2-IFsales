      ...
      <div class="drawer-content flex flex-col items-center">
        ...
        <div class="container mx-auto p-4">
          <div class="flex items-center justify-between mb-6 mt-8">
            ...
            <a class="btn btn-success btn-circle" href="${pageContext.request.contextPath}/pages/home/region/regionForm.jsp">
                ...
                <tbody>
                  <c:forEach var="region" items="${regions}">
                    <tr class="hover">
                      ...
                      <td>${region.state}</td>
                      <td class="p-1 flex">
                        <button onclick="document.getElementById('edit-${region.id}').showModal()" class="btn btn-outline btn-warning w-1/2">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10"></path>
                          </svg>
                          Editar
                        </button>
                        <button onclick="document.getElementById('delete-${region.id}').showModal()" class="btn btn-outline btn-error w-1/2">
                        ...
                        <dialog id="edit-${region.id}" class="modal">
                          <div class="modal-box">
                            ...
                            <div class="modal-body flex justify-between">
                              ...
                              <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=updateRegion&id=${region.id}">
                                Editar
                              </a>
                            </div>
                          </div>
                        ...
                        <dialog id="delete-${region.id}" class="modal">
                          <div class="modal-box">
                            ...
                            <div class="modal-body flex justify-between">
                              ...
                              <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=deleteRegion&id=${region.id}">
                                Deletar
                              </a>
                            </div>
                          </div>
        ...
        <c:choose>
          <c:when test="${result == 'registerSuccess'}">
            <div class="alert alert-success">
              ...
              <span>Região cadastrada com sucesso.</span>
            </div>
          </c:when>
          <c:when test="${result == 'updateSuccess'}">
            <div class="alert alert-success">
              ...
              <span>Região atualizada com sucesso.</span>
            </div>
          </c:when>
        </c:choose>
      </div>
