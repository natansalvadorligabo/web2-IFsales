                ...
                <form id="form1" action="${pageContext.request.contextPath}/redirect" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${salesperson != null}">
                                <input type="text" id="name" name="name" required
                                       class="input input-bordered w-full mt-2" value="${salesperson.name}">
                            </c:when>
                        </c:choose>
                    </div>
                    ...
                    <div>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${salesperson != null}">
                                <input type="email" id="email" name="email" required
                                       class="input input-bordered w-full mt-2" value="${salesperson.email}">
                            </c:when>
                        </c:choose>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="${pageContext.request.contextPath}/pages/home/salespersonTable.jsp" class="btn btn-outline btn-block">
                            Voltar
                        </a>
                    </div>
                </form>
