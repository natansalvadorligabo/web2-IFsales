...
<html lang="pt-br" data-theme="lofi">
  <jsp:include page="/components/head.jsp">
    <jsp:param name="title" value="Tabelas de Lojas - IFSales" />
  </jsp:include>
  <body>
                  ...
                  <c:forEach var="store" items="${stores}">
                    <tr class="hover">
                      ...
                      <td class="p-1 flex">
                        ...
                        <button onclick="document.getElementById('delete-${store.id}').showModal()" class="btn btn-outline btn-error w-1/2">
                        ...
                        <dialog id="edit-${store.id}" class="modal">
                          <div class="modal-box">
                            ...
                            <div class="modal-body flex justify-between">
                              ...
                              <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=updateStore&id=${store.id}">
                                Editar
                              </a>
                            </div>
                          </div>
                        ...
                        <dialog id="delete-${store.id}" class="modal">
                          <div class="modal-box">
                            ...
                            <div class="modal-body flex justify-between">
                              ...
                              <a class="btn btn-secondary w-1/2 ml-1" href="${pageContext.request.contextPath}/redirect?action=deleteStore&id=${store.id}">
                                Deletar
                              </a>
                            </div>
                          </div>
