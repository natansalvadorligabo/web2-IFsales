                ...
                <form id="form1" action="${pageContext.request.contextPath}/redirect" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${region != null}">
                                <input type="text" id="name" name="name" required
                                       class="input input-bordered w-full mt-2" value="${region.name}">
                            </c:when>
                        </c:choose>
                    </div>
                    ...
                    <div>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${region != null}">
                                <input type="text" id="city" name="city" required
                                       class="input input-bordered w-full mt-2" value="${region.city}">
                            </c:when>
                        </c:choose>
                    </div>
                    <span id="error-name" class="text-error hidden"></span>
                    ...
                    <div>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${region != null}">
                                <input type="text" id="state" name="state" required
                                       class="input input-bordered w-full mt-2" value="${region.state}">
                            </c:when>
                        </c:choose>
                    </div>
                    <span id="error-name" class="text-error hidden"></span>
