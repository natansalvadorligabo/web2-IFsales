...
<html lang="pt-br" data-theme="lofi">
  ...
  <body class="min-h-screen bg-base-200">
        ...
        <form
          ...
          <div>
            <label for="confirmPassword" class="font-semibold"
              >Confime sua senha<span class="text-error">*</span></label
            >
            <input
              type="password"
              id="confirmPassword"
          ...
          <div class="space-y-2">
            ...
            <a
              href="${pageContext.request.contextPath}/redirect?action=login"
    ...
    <script
      defer
      src="${pageContext.request.contextPath}/scripts/validateUserRegister.js"></script>
  </body>
</html>
